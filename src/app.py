...
activities = {
    ...
    "painting": {
        "description": "Painting and drawing classes",
        "participants": []
    },
    "sculpture": {
        "description": "Sculpture workshop",
        "participants": []
    },
    "chess": {
        "description": "Chess club and tournaments",
        "participants": []
    },
    "debate": {
        "description": "Debate team practice",
        "participants": []
    }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Check maximum participants if defined
